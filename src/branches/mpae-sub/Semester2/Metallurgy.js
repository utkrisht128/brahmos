...
export default function Physics() {
  return (
    <>
      ...
      <div className="box-1">
      <Pdf name={"Unit1-1"} link={"https://docs.google.com/presentation/d/1JfMGj-ealipFP35mUpFI90Dq9T3B-rST/edit?usp=sharing&ouid=115988180847881203793&rtpof=true&sd=true"} img={Img} /> 
      </div>
